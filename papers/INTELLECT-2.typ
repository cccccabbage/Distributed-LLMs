...
@issue-communication-cost[Communication Cost and Synchronization] and
@issue-communication-computation-overlap[Communication-Induced Idle Time and Computation Overlap in
  Distributed Training], particularly the RL-specific case of
@issue-asynchronous-update-staleness[Asynchronous Update Staleness]. Workers must receive a large,
continually changing policy checkpoint, while training must decide whether rollouts generated by an
older behavior policy remain useful; see also @background-reinforcement-learning[Reinforcement
  Learning].
